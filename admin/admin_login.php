...
<body class="">
              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form">
                    <label>Email</label>
                    <div class="mb-3">
                      <input type="email" autocomplete="off" class="form-control" placeholder="Email" aria-label="Email" aria-describedby="email-addon" id="email">
                    </div>
                    <label>Password</label>
                    <div class="mb-3">
                      <input type="email" autocomplete="off" class="form-control" placeholder="Password" aria-label="Password" aria-describedby="password-addon" id="pass">
                    </div>
                    ...
                    <div class="text-center">
                      <button type="button" class="btn bg-gradient-info w-100 mt-4 mb-0" id="submit">Sign in</button>
                    </div>
                  </form>
                </div>
  ...
  <script src="js/soft-ui-dashboard.min.js?v=1.0.5"></script>
  <script>
